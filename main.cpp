...
IDebugLog		gLog("MapMarkerExtensionFramework.log");
...
bool OBSEPlugin_Query(const OBSEInterface* OBSE, PluginInfo* info)
{
	...
	info->name = "MapMarkerExtensionFramework";
	info->version = 1;
...
bool OBSEPlugin_Load(OBSEInterface* OBSE)
{
	...
	g_messagingInterface->RegisterListener(g_pluginHandle, "TrueSpears", MessageHandler);
	...
	MapMarkerExtensionFramework::Install();
